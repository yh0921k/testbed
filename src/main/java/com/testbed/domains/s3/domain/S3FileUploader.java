package com.testbed.domains.s3.domain;
...
public class S3FileUploader {
  ...
  public Long getLastIndex(Long userIndex) {
  ...
  public void rename(String originKey, String newKey) {
  ...
  public List<String> reArrange(Long userIndex) {
    List<S3ObjectSummary> s3ObjectSummaryList =
        s3Client.listObjects(bucket, String.valueOf(userIndex)).getObjectSummaries();
  ...
  public String putObject(String key, MultipartFile file) throws Exception {
